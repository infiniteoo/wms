  ...
  return (
    ...
    >
      ...
      <TextInput
        ...
        onChangeText={(text) => setSignInData({ ...signInData, name: text })} // Update the state with the entered text
        style={{
          color: "black",
          width: 300,
          height: 60,
      ...
      <TextInput
        ...
        onChangeText={(text) => setSignInData({ ...signInData, phone: text })} // Update the state with the entered text
        style={{
          color: "black",
          width: 300,
          height: 60,
...
export default NameAndNumberInput;
